...
# Plugin classes
from GpxSegmentImporter.gui.gpx_segment_importer import GpxSegmentImporter as GpxSegmentImporterGUI
...
class GpxSegmentImporter:
    ...
    def __init__(self, iface):
        ...
        # gui
        self.gpx_segment_importer_gui = GpxSegmentImporterGUI(self.iface)
    ...
    def initGui(self):
        ...
        self.add_action(
            ...
            callback=self.gpx_segment_importer_gui.run,
